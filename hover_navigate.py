...
def controle_periodico(_event):
    ...
    comando_linear = pid_erro_linear.processar_pid(erro_vel_linear)
    ...
    erro_vel_angular = vel_angular_desejada - vel_angular_real

    comando_angular = pid_erro_angular.processar_pid(erro_vel_angular)
